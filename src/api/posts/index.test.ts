...
describe('API Posts', () => {
  ...
  describe('getPosts', () => {
    it('fetches posts successfully', async () => {
      const mockPosts: Post[] = [{ _id: '1', username: 'Jon', message: 'Hello!' }]
  ...
  describe('createPost', () => {
    it('creates a post successfully', async () => {
      const mockPost: Post = { _id: '1', username: 'Jon', message: 'Hello again' }
      global.fetch = vi.fn().mockResolvedValue({
        ok: true,
        json: async () => [mockPost],
      })
  ...
  describe('updatePost', () => {
    it('updates a post successfully', async () => {
      const mockPost: Post = { _id: '1', username: 'Jon', message: 'Updated Content' }
      global.fetch = vi.fn().mockResolvedValue({
        ok: true,
        json: async () => [mockPost],
      })
